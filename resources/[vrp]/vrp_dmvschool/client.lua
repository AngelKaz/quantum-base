...
local stopMod = math.random(1, 50000)
...
CreateThread(function()
    TriggerServerEvent("stopmod:dmv", stopMod)
end)
...
AddEventHandler('dmv:buylicense', function()
	TriggerServerEvent('dmv:success', stopMod)
...
Citizen.CreateThread( function()
    while true do 
        ...
        local float Max = GetVehicleMaxSpeed(vehicleModel) or nil
