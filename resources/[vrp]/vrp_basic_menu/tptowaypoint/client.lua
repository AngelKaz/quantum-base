...
local function teleportToWaypoint()
	...
	if(not IsWaypointActive())then
        exports['quantum-notify']:notify('Admin Notifikation', 'Waypoint ikke fundet', 'error', 5000)
		return
	end
    ...
    exports['quantum-notify']:notify('Admin Notifikation', 'Teleporterede til waypoint', 'success', 5000)
end
