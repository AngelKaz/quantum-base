...
function tvRP.getPosition()
  ...
  return x,y,z,GetEntityHeading(PlayerPedId())
end
...
function tvRP.notify(msg)
  ...
  exports["quantum-notify"]:notify('Ny Notifikation', msg, 'info', 7500)
end
...
AddEventHandler("playerSpawned",function()
    TriggerServerEvent("quantum-multikarakter:SetupStart")
end)
