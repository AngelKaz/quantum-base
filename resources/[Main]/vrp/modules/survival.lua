            ...
            if nuser_id ~= nil then
                vRPclient.isInComa(nplayer,{}, function(in_coma)
                    if in_coma then
                        ...
                        TriggerClientEvent('quantum-notify:notify', player, 'Ny Notifikation', 'Ikke i koma!', 'error', 5000)
                    end
                end)
            else
                TriggerClientEvent('quantum-notify:notify', player, 'Ny Notifikation', 'Der er ingen spillere nær dig!', 'error', 5000)
            end
        end)
    end
