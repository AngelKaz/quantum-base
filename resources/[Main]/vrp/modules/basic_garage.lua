function vRP.getUserVehiclesByCPR(cpr, cb)
    local split = {}
...
for group,vehicles in pairs(vehicle_groups) do
    ...
    local menu = {
        ...
        css={top = "75px", header_color="#0d1624"}
    }
