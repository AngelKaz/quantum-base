...
function vRP.getUserAddress(user_id, cb)
        ...
        if huser_id ~= nil then
          if huser_id == user_id then
            vRP.accessHome(user_id, home_name, number, function(ok)
              if not ok then
              TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.home.intercom.not_available()}, type = "info", queue = "global",timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
              end
            end)
          else
            ...
            if hplayer ~= nil then
              vRP.prompt(player,lang.home.intercom.prompt_who(),"",function(player,who)
				TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.home.intercom.asked()}, type = "info", queue = "global",timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"},killer = true})
                vRP.request(hplayer, lang.home.intercom.request({who}), 30, function(hplayer,ok)
                  if ok then
                    vRP.accessHome(user_id, home_name, number)
                  else
                    TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.home.intercom.refused()}, type = "info", queue = "global",timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
                  end
                end)
              end)
            else
        ...
        vRP.findFreeNumber(home_name, home.max, function(number)
          if number ~= nil then
            if vRP.tryPayment(user_id, home.buy_price) then
              ...
              TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.home.buy.bought()}, type = "info", queue = "global",timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
            else
              TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.money.not_enough()}, type = "info", queue = "global",timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
            end
          else
            TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.home.buy.full()}, type = "info", queue = "global",timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
          end
        end)
      else
    TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.home.buy.have_home()}, type = "info", queue = "global",timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})  
      end
    end)
  ...
  menu[lang.home.sell.title()] = {function(player,choice)
    vRP.getUserAddress(user_id, function(address)
      if address ~= nil and address.home == home_name then -- check if already have a home
        ...
        TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.home.sell.sold()}, type = "info", queue = "global",timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
      else
    TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.home.sell.no_home()}, type = "info", queue = "global",timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
      end
    end)
